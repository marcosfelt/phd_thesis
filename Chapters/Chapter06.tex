...
\section{Why does the multi-task model improve performance}

% Table with MAE and r2 when using single-task vs multitask model


\section{Why does using a classifier improve performance?}

% Classifier calibration
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{gfx/Chapter06/classifier_calibration.png}
    \caption{Calibration curve of GP classifier trained on 80\% of pretraining data for ControlBO optimization and tested on the remaining 20\%. The correlation of predicted and actual probability of success suggests that classifier is well calibrated.}
