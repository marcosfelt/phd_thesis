...
\begin{figure}
    \centering
    \includegraphics{figures/basic_column.png}
...
\begin{table}
    ...
    \begin{tabular}{cccc}
        ...
        \hline
         $P_{top}$ & \thead{Pressure on stage \\ $N$ of the column} &  0.5 & 0.22 \\ 
         $q_{N_F}$ & \thead{vapor fraction  \\ in the feed} & 1.0 & 1.0 \\
         $z_{N_F}$  & \thead{mole fraction of methanol \\ in the feed} &  0.5  & 0.5 \\
         $F$ & \thead{Feed flow rate} &  333 mol/min  & 332 mol/min \\
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{cc}
        ...
        \hline
         $x_i$ & \thead{Liquid composition of methanol on stage $i$}  \\
         $y_i$ & \thead{Vapor composition of water on stage $i$}\\
         $L_i$ & \thead{Liquid flow on stage $i$}  \\
         $V_i$  & \thead{Vapor flow on stage $i$} \\
         $T_i$  & \thead{Temperature on stage $i$} \\
         $T_i$  & \thead{Holdup on stage $i$} \\
    \end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{figures/weir.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/simulation_workflow.png}
...
\begin{table}[]
    ...
    \begin{tabular}{cccc}
        ...
        \hline
         $\alpha_{strip}$ & \thead{Murphree efficiency \\ in stripping section} &  0.5 & 0.22 \\ 
         $\alpha_{rect}$ & \thead{Murphree efficiency \\ in rectifying section} & 0.5 & 1.0 \\
         ...
         $ Q_{reb}$ & \thead{Reboiler duty \\ at steady state} &  0.245 kW  & 0.259 kW  \\
         $ Q_{cond}$ & \thead{Condenser duty \\ at steady state} &  -0.239 kW  & -0.253 kW
    \end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/2021_11_17_steady_state_estimated.png}
...
\begin{figure}
    \begin{subfigure}[c]{0.49\textwidth}
        \centering
        \includegraphics[clip,width=\textwidth]{figures/2021_11_18_steady_state_temperature.png}
        \subcaption{}
    \end{subfigure}
    \begin{subfigure}[c]{0.49\textwidth}
        \centering
