...
\begin{itemize}
    ...
    \item RL trained on specific configuration is not transferable: A new agent would need to be trained for each new configuration of the distillation column, which is unacceptable given the above training constraint.
