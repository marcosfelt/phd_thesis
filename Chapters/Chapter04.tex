...
\begin{figure}[t]
  \centering
  \includegraphics[height=0.3\textheight]{gfx/Chapter04/lv_configuration_inferential.png}
...
%\begin{figure*}[bt]
%  \includegraphics[width=\textwidth, keepaspectratio]{gfx/Chapter04/two_by_two_control_loop}
...
\begin{figure}[bt]
  \centering
  \includegraphics[scale=0.3]{gfx/Chapter04/relay_tuning.png}
...
\section{Methods}
\begin{figure}
  \includegraphics[width=\linewidth]{gfx/Chapter04/rl_tuning_loop.png}
...
\begin{figure*}[tb]
  \includegraphics[width=\textwidth]{gfx/Chapter04/dis3_74_reward_parameters.png}
...
\begin{figure*}[p]
  \includegraphics[width=\textwidth]{gfx/Chapter04/20200424_trained_policy_sixty_minutes.png}
...
\begin{figure}[t]
  \includegraphics[width=1.2\textwidth]{gfx/Chapter04/dis3_74_errors_oscillations}
...
\begin{figure}[t]
  \includegraphics[width=1.2\textwidth]{gfx/Chapter04/oscillations_study.png}
