...
\begin{figure}
    \centering
    \includegraphics{gfx/Chapter04/self_optimisation_setup.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.2\textwidth]{gfx/Chapter04/baumgartner_suzuki_reizman_suzuki_one_cotraining_optimisation.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{gfx/Chapter04/baumgartner_suzuki_reizman_suzuki_case_2_optimisation_uncertainty.png}
...
\begin{figure}
    \includegraphics[width=\textwidth]{gfx/Chapter04/catalyst_optimisation.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{gfx/Chapter04/ch_activation_optimisation_curves.png}
